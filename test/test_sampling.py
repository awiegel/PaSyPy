...
class TestPreSampling(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.constraints = z3.And(cls.x >= 1/2, cls.y >= 1/4, cls.x >= cls.y)
    ...
    def test_empty_queue(self):
        ...
        variables.queue = []
        self.pre_sampling.get_pre_sampling_candidate(self.constraints.children()[0])
        self.assertEqual([self.x >= 1/2], self.pre_sampling.candidates)
        self.pre_sampling.get_pre_sampling_candidate(self.constraints.children()[1])
